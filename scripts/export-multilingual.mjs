...
const out=resolve('gh-pages-output'),base='/IntPEL-Website',stylesheet='site-v25.css';
...
for(const [lang] of languages)for(const page of routes){
 ...
 const title=pageTitle(page,lang)+' — '+translate('Integrated Power Electronics Systems Research Team',lang);
 const alternates=languages.map(([code])=>`<link rel="alternate" hreflang="${code}" href="https://YiDou1994.github.io${pageUrl(page,code,base)}">`).join('');
